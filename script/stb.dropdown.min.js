!function(t){
  var e=t('<div class="stb-select-container" id="newContainer" tabindex="-1"><span class="selected" id="newSelect"></span></div>'),
  ...
  t.fn.stbDropdown=function(){
    ...
    i.each(function(i,a){
      ...
      c.each(function(e,n){
        ...
        var l,
        p=r.children("option").filter(function(e,n){
          return t(n).is("[selected]")
        });
        l=0==p.length?c.first():p.first(),
        o.find(".selected").text(l.text()),
        o.on("click.stb.select",function(){
          var e=t(this),
          n=t.grep(t(".stb-select-container"),
          function(n){
            return!e.is(t(n))
          });
          t(n).find("ul").hide(),
        ...
        o.on("click.stb.option","li",function(e){
          ...
          n.parents("ul").toggle();
          var o=i.find("select");
          o.val(n.attr("value")).change(),
          n.siblings().removeAttr("selected"),
